...
def write_svg(rows: list[dict[str, object]], metrics: dict[str, float], path: Path) -> None:
  ...
  <g font-family="Arial, sans-serif">
    ...
    <text x="72" y="636" font-size="16" font-weight="700" fill="#111827">Known</text>
    <text x="132" y="636" font-size="16" fill="#374151">Daily transit calls by broad vessel class through IMF PortWatch's Hormuz chokepoint boundary.</text>
    <text x="72" y="664" font-size="16" font-weight="700" fill="#111827">Unknown</text>
    <text x="152" y="664" font-size="16" fill="#374151">Vessel identity, direction, AIS-dark movements, and actual cargo onboard.</text>
    <text x="72" y="704" font-size="14" fill="#6b7280">Source: IMF PortWatch Daily_Chokepoints_Data, chokepoint6; calculations by project. Capacity fields are metric-ton estimates, not barrels.</text>
  </g>
</svg>
'''
    path.write_text(svg)
